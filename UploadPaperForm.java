...
public class UploadPaperForm extends JDialog {
    ...
    private static final Color ACCENT_BLUE = new Color(0x1E, 0x5A, 0xE8);
    ...
    private static final Color REQUIRED_RED = new Color(0xE0, 0x4F, 0x4F);
    ...
    private JPanel buildButtonRow() {
        ...
        SolidButton uploadBtn = new SolidButton(" Upload", ACCENT_BLUE, Color.WHITE, new UploadIcon(Color.WHITE));
